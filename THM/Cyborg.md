...
Хорошо, что он не запаролен для открытия. (Позднее я понял что он зашифрован внутри и вообще это borg backup, который использует хорошее шифрование и достать оттуда ничего не получится)
